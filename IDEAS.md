...
|---|---|---|---|---|---|---|
| 1 | Prove permission ACL on the local ER via the L1 `create_permission` + `delegate_permission` path | 5 | 3 | 5 | 75 | BUILT |
...
| 18 | Rematch wired on-chain against the same opponent | 3 | 3 | 3 | 27 | BUILT |
| 19 | Fade-the-winner: challenge a tape's winner directly | 3 | 3 | 4 | 36 | BUILT |
...
| 25 | Position size slider instead of a fixed fill | 2 | 4 | 3 | 24 | BUILT |
...
| 30 | Transaction retry with backoff | 3 | 4 | 2 | 24 | BUILT |
| 31 | Match state reconciliation on reload | 3 | 3 | 3 | 27 | BUILT |
| 32 | Winner celebration in pixel blocks | 3 | 4 | 3 | 36 | BUILT |
| 33 | Loss CRT glitch | 3 | 4 | 3 | 36 | BUILT |
...
| 39 | Keyboard shortcuts for L/C/settle | 2 | 5 | 2 | 20 | BUILT |
...
| 49 | Variable round duration presets | 2 | 4 | 2 | 16 | BUILT |
...
| 55 | Per-wallet match history | 3 | 4 | 3 | 36 | BUILT |
| 56 | Region select for the ER validator | 3 | 4 | 3 | 36 | BUILT |
| 57 | TEE attestation display (`verifyTeeRpcIntegrity`) | 4 | 3 | 5 | 60 | BUILT |
| 58 | Auth-token session panel | 3 | 2 | 4 | 24 | SKIPPED (needs TEE) |
| 59 | Commit-frequency control + live commit indicator | 3 | 3 | 3 | 27 | BUILT |
...
| 73 | Accessibility labels on every control | 3 | 4 | 2 | 24 | BUILT |
...
| 77 | Fill row slide-in | 2 | 3 | 3 | 18 | BUILT |
...
| 84 | Rate-limit protection on polling | 2 | 4 | 2 | 16 | BUILT |
...
| 92 | Auto-reconnect on RPC drop | 3 | 3 | 2 | 18 | BUILT |
...
| 98 | Mobile-responsive duel screen | 3 | 4 | 2 | 24 | BUILT |
| 99 | Cluster switcher in the UI | 3 | 4 | 3 | 36 | BUILT |
